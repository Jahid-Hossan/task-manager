...
const Login = () => {
    ...
    const { popUpGoogle, emailLogin } = useAuth();
                        ...
                        <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="mt-8">
                                <div className="space-y-5">
                                    ...
                                    <div>
                                        <button type="submit" className="inline-flex bg-red-500  items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-btn-clr border border-transparent rounded-md focus:outline-none hover:bg-navy focus:bg-blue-700">Log in</button>
                                    </div>
                                </div>
                            </form>
