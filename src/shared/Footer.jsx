    ...
    return (
        <footer className="">
            <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
                <div className="flex justify-center font-bold font-Jost text-5xl text-red-500">
                    Taskey
                </div>
                ...
                <ul className="mt-6 flex justify-center gap-6 md:gap-8">
                    <li>
                        <a
                            href="https://www.facebook.com/JahidHRJ/"
                            rel="noreferrer"
                            target="_blank"
                    ...
                    <li>
                        <a
                            href="https://www.instagram.com/jahid_bangali/"
                            rel="noreferrer"
                            target="_blank"
                            className="text-gray-700 transition hover:text-gray-700/75"
                        >
                    ...
                    <li>
                        <a
                            href="https://twitter.com/JahidHRJ"
                            rel="noreferrer"
                            target="_blank"
                            className="text-gray-700 transition hover:text-gray-700/75"
                        >
                    ...
                    <li>
                        <a
                            href="https://github.com/Jahid-Hossan"
                            rel="noreferrer"
                            target="_blank"
                            className="text-gray-700 transition hover:text-gray-700/75"
                        >
