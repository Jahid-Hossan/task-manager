    ...
    return (
        <div>
            ...
            <div className='lg:flex items-center '>
                <div className='my-6 space-y-7  lg:w-1/2'>
                    ...
                    <Link to={'/dashboard'} className="btn bg-red-500 text-white font-bold hover:text-black">Let’s Explore <FaArrowRight /></Link>
                </div>
                <div className='lg:w-1/2 flex justify-center' >
                    <img src={banner} alt="" className='lg:w-2/3' />
                </div>
            </div>
        </div>
    );
